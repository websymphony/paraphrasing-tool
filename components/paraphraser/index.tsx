  ...
  return (
    <>
      ...
      />
        ...
        <main>
          <section className="py-4 mx-auto border border-gray-100 rounded-lg shadow-sm max-w-7xl sm:px-6 lg:px-4">
            ...
            <div className="p-4 sm:px-0">
              <div className="grid grid-cols-2 gap-x-1">
                ...
                <label htmlFor="outputText">
                  ...
                  <textarea name="outputText" className="block w-full p-4 border-2 border-gray-200 rounded-lg resize-none h-96 disabled:opacity-60 sm:text-sm md:text-lg focus:outline-none focus:ring focus:border-blue-600" placeholder="You will get the resulting text here after the paraphrasing tool has finished rephrasing." value={outputText} disabled={paraphraseLoading} readOnly></textarea>
                </label>
              </div>
            </div>
            <div className="relative flex items-center justify-center">
              ...
              <button type="button" className="flex items-center justify-center max-w-md py-2 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md disabled:opacity-60 px-7 hover:bg-blue-700 md:py-3 md:text-lg md:px-10" onClick={handleParaphraseSubmission} disabled={[...inputText].length <= 10 || [...inputText].length > 500 || paraphraseLoading}>
          ...
          <section className="py-24 bg-white">
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
              <div className="lg:text-center">
                <h2 className="text-base font-semibold tracking-wide text-blue-600 uppercase">Best Article Rewriter & Paraphrasing Tool</h2>
              ...
              <div className="mt-10">
                <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                  <div className="flex p-6 prose rounded-lg bg-gray-50 lg:prose-lg">
                  ...
                  <div className="flex p-6 prose rounded-lg bg-gray-50 lg:prose-lg">
                    ...
                    <div className="ml-4">
                      ...
                      <div className="mt-2 text-gray-500">
                        ...
                        <p>You can also follow our guide to effectively <Link href="/how-to-paraphrase-sources">paraphrase sources</Link>.</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex p-6 prose rounded-lg bg-gray-50 lg:prose-lg">
                    ...
                    <div className="ml-4">
                      ...
                      <div className="mt-2 text-gray-500">
                        <p className="pb-2">
                          If you are writing a thesis and are using a paraphrasing tool for assistance. Follow <Link href="/how-to-use-paraphrasing-tool-to-write-thesis">our guide</Link> with tips to avoid common mistakes.
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        </main></>) : (<h1 className="p-20 text-2xl text-center">The service is unavailable in Australia under the "Tertiary Education Quality and Standards Agency Amendment" law.</h1>)}
    </>
  )
}